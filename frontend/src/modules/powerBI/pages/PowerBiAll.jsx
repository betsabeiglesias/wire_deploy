            ...
            >
              <div
                className={`absolute inset-0 ${
                  isDark
                    ? "opacity-35 [background-image:radial-gradient(#7ec8ff_1px,transparent_1px)] [background-size:8px_8px]"
                    : "opacity-70 [background-image:radial-gradient(#d9cdf7_1px,transparent_1px)] [background-size:8px_8px]"
                }`}
              />
              <div
                className={`absolute right-[-40px] top-[-40px] h-[260px] w-[260px] rounded-full ${
                  isDark
                    ? "bg-[radial-gradient(circle,rgba(114,176,255,0.16),transparent_72%)]"
                    : "bg-[radial-gradient(circle,rgba(196,181,253,0.18),transparent_72%)]"
                }`}
              />
              ...
              <div className="relative z-10 grid gap-6 xl:grid-cols-[1.2fr_0.8fr] xl:items-end">
                <div className="max-w-3xl">
                  <h1
                    className={`mt-5 text-4xl font-semibold leading-[0.95] tracking-[-0.05em] md:text-6xl ${
              ...
              {isLoading && (
                <div
                  className={`rounded-[24px] px-5 py-4 text-sm ${
                    isDark
                      ? "border border-white/10 bg-white/6 text-[#9fb4d8]"
                      : "border border-[#ececee] bg-white text-[#8f919a]"
                  }`}
                >
                  Cargando vistas...
                </div>
