...
const ProductionView = () => {
  ...
  >
    Editar HMI
      ...
      <div className="fixed top-4 right-4 z-50 bg-white px-3 py-1 rounded shadow text-sm">
        {connected ? (
        ...
        {layoutName && (
          <div
            className="text-gray-700 text-xs mt-0.5 font-semibold"
            title={layoutName}
          >
            {layoutName}
          </div>
      ...
      <div className="relative w-[1200px] h-[1200px] mx-auto mt-16 bg-white shadow-sm border border-gray-200">
