...
const SidebarPanel = ({
  ...
  return (
    <div className="w-72 h-full min-h-0 overflow-hidden bg-slate-100/90 backdrop-blur border-r border-slate-300/60 flex flex-col shadow-sm">
      ...
      {/* Proyecto & Tema */}
      <div className="shrink-0 p-3 border-b border-slate-300/60 bg-slate-100/70 backdrop-blur-md space-y-3">
        ...
        <div className="px-3 pb-1">
          <div className="flex items-center gap-2 text-[10px] font-bold tracking-widest text-slate-400 mb-2">
            <Palette size={12} /> ESTÉTICA
          </div>
          <select
            value={themeId}
            onChange={(e) => setThemeId(e.target.value)}
            className="w-full p-2 rounded-lg border border-slate-300 bg-white text-xs font-medium text-slate-700 outline-none transition-all shadow-sm focus:border-sky-500"
          >
