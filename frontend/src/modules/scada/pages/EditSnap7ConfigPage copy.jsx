    ...
    return (
      <div className="flex flex-col h-full bg-[#EFEFEF] overflow-hidden">
        ...
        <ProtocolNotice
          ...
          description={`Este dispositivo no usa Siemens Snap7, sino ${protocolLabels[protocolMismatch] || protocolMismatch}. Para editar su configuracion, abre la pantalla del protocolo correspondiente.`}
