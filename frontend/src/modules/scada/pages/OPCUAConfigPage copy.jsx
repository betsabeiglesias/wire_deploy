    ...
    <div className="flex flex-col h-full bg-[#EFEFEF] overflow-hidden">
      ...
      <DeviceWizardTabs
        steps={[
          ...
          { key: "config", label: "Configuracion", description: "OPC UA", to: "/devices/new/opcua", enabled: true, current: true },
        ...
        <div className="max-w-2xl mx-auto flex flex-col gap-3">
          ...
          <section className={panelCls}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1">
                <label className={labelCls}>PolÃ­tica de seguridad</label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-[12px] text-slate-700">Habilitar reconexiÃ³n</span>
            </label>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
                <label className={labelCls}>Delay mÃ­nimo (ms)</label>
              ...
              <div className="flex flex-col gap-1">
                <label className={labelCls}>Delay mÃ¡ximo (ms)</label>
          ...
          <section className={panelCls}>
            <h2 className={secTitleCls}>SuscripciÃ³n</h2>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
                <label className={labelCls}>Intervalo publicaciÃ³n (ms)</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
                <label className={labelCls}>TamaÃ±o de cola</label>
              ...
              <label className="mt-4 flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-[12px] text-slate-700">Descartar mÃ¡s antiguos</span>
              </label>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
