    ...
    <div className="flex flex-col h-full bg-[#EFEFEF] overflow-hidden">
      ...
      <DeviceWizardTabs
        steps={[
          ...
          { key: "config", label: "Configuracion", description: "Siemens Snap7", to: "/devices/new/snap7", enabled: true, current: true },
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="max-w-2xl mx-auto flex flex-col gap-3">
          ...
          <section className={panelCls}>
            ...
            <div className="flex flex-col gap-1">
              <label className={labelCls}>Hostname / DirecciÃ³n IP *</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1">
                <label className={labelCls}>TamaÃ±o PDU</label>
                ...
                <span className={hintCls}>240â€“960 bytes (defecto: 480)</span>
              </div>
            </div>
          </section>
          ...
          <section className={panelCls}>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className={hintCls}>Con quÃ© frecuencia leer el PLC (recomendado: 1000 ms)</span>
            </div>
          </section>

          <section className={panelCls}>
            <h2 className={secTitleCls}>ReconexiÃ³n</h2>
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-[12px] text-slate-700">Habilitar reconexiÃ³n automÃ¡tica</span>
            </label>
