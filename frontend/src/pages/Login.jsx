    ...
    <div className="min-h-screen bg-[#0b1631] p-4 md:p-6">
      <div className="relative min-h-[calc(100vh-2rem)] overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(160deg,#09152f_0%,#0d1d40_42%,#132857_100%)] shadow-[0_40px_90px_-50px_rgba(0,0,0,0.7)] md:min-h-[calc(100vh-3rem)]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-2rem)] max-w-7xl items-center px-4 py-8 md:min-h-[calc(100vh-3rem)] md:px-8">
          ...
          {/* USAMOS FLEX-ROW-REVERSE PARA PRIORIZAR EL LOGIN AL REDUCIR ANCHO */}
          <section className="flex w-full flex-row-reverse items-center justify-between gap-10">
            
            {/* COLUMNA DERECHA: LOGIN (Se mantiene intacto y no se encoge) */}
            <div className="relative flex w-full max-w-[430px] shrink-0 flex-col items-center">
              <img
                src={rdtLogo}
                alt="RDT"
                ...
                <div className="relative z-10">
                  ...
                  <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                    <label className="block">
                      <span className="mb-2 block text-sm font-medium text-[#4a617f]">Usuario</span>
                    ...
                    <label className="block">
                      <span className="mb-2 block text-sm font-medium text-[#4a617f]">Contraseña</span>
                      <div className="flex items-center gap-3 rounded-2xl border border-[#d9e0e5] bg-white px-4 py-3 shadow-[0_18px_30px_-28px_rgba(31,41,55,0.16)]">
                    ...
                    <p className="pt-2 text-center text-sm text-[#7f90a5]">
                      ...
                      <Link to="/ayuda" className="font-semibold text-[#194b68] hover:underline transition-colors duration-200">
                        Haz click aquí
                      </Link>
                    </p>
                  </form>
            ...
            {/* COLUMNA IZQUIERDA: Corregida para centrar cabecera y mantener checklist */}
              <div className="hidden min-w-0 flex-1 flex-col items-center gap-8 lg:flex max-w-[560px]">
                ...
                <div className="space-y-5 text-center">
                  ...
                  <p className="max-w-xl mx-auto text-base leading-7 text-[#9fb4d8]">
              ...
              {/* RECUADRO CHECKLIST RESTAURADO AL 100% */}
<div className="relative ml-16 w-full max-w-[420px] rounded-[22px] border border-[#d9e0e5] bg-[linear-gradient(180deg,#ffffff_0%,#f4f8f9_100%)] px-6 py-5 text-[#2f3942] shadow-[0_30px_60px_-30px_rgba(31,41,55,0.18)]">                <div className="flex items-center justify-between">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <div className="rounded-2xl border border-[#dce3e8] bg-white p-4 text-center shadow-[0_16px_24px_-24px_rgba(31,41,55,0.14)]">
                    ...
                    <p className="mt-3 text-sm font-medium text-[#2f3942]">Control</p>
                  </div>
                  <div className="rounded-2xl border border-[#dce3e8] bg-white p-4 text-center shadow-[0_16px_24px_-24px_rgba(31,41,55,0.14)]">
                    <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-2xl bg-[#fff8e8] text-[#8f6a18]">
                      <ChartColumn className="h-5 w-5" />
                    </div>
                    <p className="mt-3 text-sm font-medium text-[#2f3942]">Analitica</p>
                  </div>
                  <div className="rounded-2xl border border-[#dce3e8] bg-white p-4 text-center shadow-[0_16px_24px_-24px_rgba(31,41,55,0.14)]">
                    <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-2xl bg-[#f2f4f7] text-[#49566f]">
                      <FileBarChart2 className="h-5 w-5" />
                    </div>
                    <p className="mt-3 text-sm font-medium text-[#2f3942]">Reportes</p>
                  </div>
                  <div className="rounded-2xl border border-[#dce3e8] bg-white p-4 text-center shadow-[0_16px_24px_-24px_rgba(31,41,55,0.14)]">
                    <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-2xl bg-[#eef5f8] text-[#255f82]">
                      <MonitorUp className="h-5 w-5" />
                    </div>
                    <p className="mt-3 text-sm font-medium text-[#2f3942]">HMI</p>
                  </div>
                </div>

                {/* Gráfico circular inferior */}
                <div className="absolute -bottom-6 left-5 flex items-end gap-3 rounded-[20px] border border-[#d9e0e5] bg-[linear-gradient(180deg,#ffffff_0%,#f3f6f8_100%)] px-4 py-3 shadow-[0_20px_40px_-25px_rgba(31,41,55,0.16)]">
                  ...
                  <div className="text-xs text-[#667380]">
                    <div className="flex items-center gap-2">
                      <span className="h-2.5 w-2.5 rounded-full bg-[#255f82]" /> Product BI
                    </div>
                    <div className="mt-1 flex items-center gap-2">
                      <span className="h-2.5 w-2.5 rounded-full bg-[#e9c46a]" /> Product HMI
                    </div>
                    <div className="mt-1 flex items-center gap-2">
                      <span className="h-2.5 w-2.5 rounded-full bg-[#b8c7d3]" /> Product IIoT
                    </div>
                  </div>
                </div>
              </div>
